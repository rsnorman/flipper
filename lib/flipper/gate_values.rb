...
module Flipper
  class GateValues
    ...
    def initialize(adapter_values)
      ...
      @percentage_of_actors = Typecast.to_percentage(adapter_values[:percentage_of_actors]) if adapter_values[:percentage_of_actors]
      @percentage_of_time = Typecast.to_percentage(adapter_values[:percentage_of_time]) if adapter_values[:percentage_of_time]
    end
